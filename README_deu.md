...
> **Updater-Sicherheit:** automatische install- und update-Vorgänge führen nur build-test aus, niemals einen versionierten Build. Release-Builds bleiben eine explizite menschliche Aktion.
