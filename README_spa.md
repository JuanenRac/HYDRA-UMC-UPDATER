...
Tampoco los 56 proyectos pertenecen a la CM5 en sí - la mayoría de los
...
- **Detección local**: para cada uno de los 56 proyectos conocidos,
...
- **Sin lógica de build por stack en esta herramienta.** El ecosistema
  ...
  nombres reales usados en los 56 proyectos) y ejecuta el que exista.
