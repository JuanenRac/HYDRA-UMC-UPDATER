...
> **Seguridad de Updater:** install y update automáticos ejecutan solo build-test, nunca una compilación versionada. Las compilaciones de publicación siguen siendo una acción humana explícita.
